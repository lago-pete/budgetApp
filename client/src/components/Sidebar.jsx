    ...
    return (
        <nav className="sidebar glass-panel" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div>
                ...
                <button onClick={logout} className="btn-secondary full-width" style={{ marginTop: '0.5rem', background: 'rgba(255, 59, 48, 0.1)', color: 'var(--danger)', border: '1px solid var(--danger)' }}>
